...
- [x] 1.1 Write property test for schema constraints
...
- [x] 3. Implement DiscussionService for thread and comment management
  ...
  - [x] 3.9 Write unit tests for DiscussionService
...
- [x] 7. Write integration tests for complete flows
...
- [x] 10. Integrate discussion link into tuition centre modal
  ...
  - [x] 10.2 Write unit test for modal integration
...
- [x] 12. Add authentication context and hooks
  ...
  - [x] 12.3 Write unit tests for auth context
