...
- [x] 3. Implement tuition centre service layer
  ...
  - [x] 3.6 Write property test for level filtering
  ...
  - [x] 3.7 Write property test for subject filtering
...
- [-] 6. Implement API route for get by ID
  - [x] 6.1 Create get by ID endpoint route handler
  ...
  - [x] 6.4 Write property test for required fields
...
- [x] 7. Implement input validation and sanitization
  - [x] 7.1 Add phone number validation
