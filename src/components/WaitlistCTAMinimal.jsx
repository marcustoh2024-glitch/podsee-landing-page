...
export default function WaitlistCTAMinimal() {
  ...
  return (
    <div className="space-y-3 text-center max-w-md mx-auto">
      ...
      <h2 className="text-[18px] md:text-[22px] font-light text-[#2C3E2F] leading-snug tracking-tight">
      ...
      <form onSubmit={handleSubmit} className="space-y-2.5 pt-1">
        <input
          ...
          required
          className="w-full px-4 py-3 rounded-full border border-[#2C3E2F]/20 text-[#2C3E2F] text-[14px] text-center placeholder:text-[#6B7566]/60 focus:outline-none focus:border-[#2C3E2F]/40 transition-all duration-300 bg-white/40 font-light"
        />
        
        {/* Submit button - minimal, elegant */}
        <button
          type="submit"
          className="w-full py-3 rounded-full bg-[#2C3E2F] text-white text-[15px] font-light tracking-wide transition-all duration-300 ease-emphasized hover:bg-[#3D5240] active:scale-[0.98] shadow-sm hover:shadow-md"
        >
          Join the Waitlist
        </button>
      </form>
